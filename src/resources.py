...
# classes
class Weapon:
    def __init__(self, weaponname, damage) -> None:
...
class Character:
    ...
    def __init__(self, name, health, armor):
        ...
        self.weaponname = self.weapon.get_name() 
    ...
    def generate_weapon(self):
        ...
        elif random_weapon >= 40 and random_weapon < 60: self.weapon = Weapon("Small Knife", 2)
        elif random_weapon >= 60 and random_weapon < 80: self.weapon = Weapon("Spear", 3)
        ...
        elif random_weapon == 96: self.weapon = Weapon("Ateish", 50)
